    ...
    try {
      ...
      if (querySnapshot.empty) {
        ...
        const newUser = {
          ...
          address: "",
          data: "",
          fone: result.user.phoneNumber || "",
          password: "" // Não armazena senha para login com Google
        };
      ...
      // Salva os dados do usuário no localStorage
      localStorage.setItem("user", JSON.stringify({
        id: querySnapshot.empty ? Date.now() : querySnapshot.docs[0].data().id,
        ...
        <div className="max-w-md mx-auto">
          <Card className="shadow-lg">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Acesse sua conta DriveEasy para gerenciar seus aluguéis
              </CardDescription>
            </CardHeader>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    to="#"
                    className="text-sm text-brand-blue hover:text-blue-700"
                  >
                    Esqueceu a senha?
                  </Link>
                </div>
